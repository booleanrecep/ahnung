...
const Admin = () => {
  ...
  const handleSubmit =async (e) => {
    ...
    const id = setTimeout(()=>setState({title: "", text: "",created:"none"}),100)     
    
      return (()=>(clearTimeout(id) ,router.push("/blog?lang=" + router.query.lang)))();
    } catch (error) {
      console.log(error)
    }
  };
  ...
  return (
    <>
      {load === true ? (
        ...
        <>
        <div style={{display:state.created}} className="article-created">&#10004; {state.title} created</div>
